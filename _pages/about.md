...
My research interest is in optimization and learning theory, including resource-constrainted convex optimization and sequential decision making. My research advisor is Prof. [Moise Blanchard](http://moiseb.github.io).
...
Write-ups: <a href="/files/9_21_Huber_robust_covariance_estimation_cvx.pdf">$l^1$-penalized robust sparse covariance estimation</a>, <a href="/files/Huber robust covariance estimation oracle rate.pdf">Large robust sparse covariance estimation with oracle rate</a>.

<h2 id="teaching"> Teaching</h2>

- TA for  Mathematical Analysis I (GEMA1009) & II (GEMA1010) at ShanghaiTech University (09/2021 - 07/2022)
- TA for  Advanced Optimization (ISYE4133) and Statistical Methods (ISYE6739) at GeorgiaTech
